...
enum DownloadStatus {
  ...
  factory DownloadStatus._parseNSKeys(String key) {
    switch (key) {
      ...
      default:
        throw Exception(
            'NSMetadataUbiquitousItemDownloadingStatusKey[$key] is not handled');
    }
  }
}
...
class ICloudFile {
  ...
  ICloudFile.fromMap(Map<dynamic, dynamic> map)
      : relativePath = map['relativePath'] as String,
        ...
        downloadStatus = DownloadStatus._parseNSKeys(map['downloadStatus']),
